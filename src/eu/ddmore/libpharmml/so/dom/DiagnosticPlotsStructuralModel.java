    ...
    extends PharmMLRootType
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "IndivPredictionVsObserv", namespace = "http://www.pharmml.org/so/0.1/StandardisedOutput", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "VPC", namespace = "http://www.pharmml.org/so/0.1/StandardisedOutput", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "IndivFits", namespace = "http://www.pharmml.org/so/0.1/StandardisedOutput", type = JAXBElement.class, required = false)
    })
